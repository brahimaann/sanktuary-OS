...
const ANCHOR_EVENTS: TimelineEvent[] = [
  {
    ...
    summary:
      'King Piye of Kush conquered Egypt, establishing the Twenty-fifth Dynasty. The stela details his Nile campaign, showing a highly advanced understanding of political legitimacy, divine right, and psychological restraint.',
    mediaType: 'text',
    ...
    principle: {
      ...
      systemOfRestraint:
        'Eurocentric histories separated Nubian achievements from Black African agency, framing them as foreign conquerors rather than native restorers.',
      culturalExpression:
        "Granite carving combining military triumph with religious devotion, emphasizing Piye's love of horses and temple restoration.",
      inferencePrompt:
        'Piye ruled by positioning himself as the inheritor of tradition rather than a destroyer. How does modern political leadership align or clash with the deep-rooted values of your community?',
    },
    primarySourceText:
  ...
  },
  {
    ...
    summary:
      'Following the Battle of Kirina, Sundiata Keita promulgated the Manden Charter, one of the oldest constitutions in the world. It established human rights, personal responsibilities, and ecological conservation in the Mali Empire.',
    mediaType: 'text',
    ...
    principle: {
      ...
      systemOfRestraint:
        'European legal theory claims human rights originated with the Magna Carta, ignoring that African societies codified human rights and environmental protection centuries prior.',
      culturalExpression:
        'Codified in 44 articles, preserved by the djelis (griots) and institutionalized in sanankunya (joking relationships) to defuse clan conflict.',
      inferencePrompt:
        "The Manden Charter legislated ecological conservation (Article 38) and prisoners of war treatment (Article 41) in 1236. What rights are currently missing from your society's legal system?",
    },
    primarySourceText:
  ...
  },
  {
    ...
    summary:
      'The Haitian Revolution was catalyzed by a secret Vodou congress led by Dutty Boukman and Cécile Fatiman. It united diverse African ethnic groups in a common struggle for armed liberation.',
    mediaType: 'text',
    ...
    location: { lat: 19.75, lng: -72.2, name: 'Bois Caïman, Saint-Domingue (Haiti)' },
    principle: {
      corePrinciple: 'Ontological Warfare and Spiritual Unity',
      systemOfRestraint:
        'Colonial history pathologized Vodou as devil worship to deny its role as a sophisticated political and military unifying system.',
      culturalExpression:
        'A ceremony combining political military briefing with spiritual ritual, using Ewe-Fon, Kongo, and Yoruba rhythms and dances.',
      inferencePrompt:
        'Boukman exhorted the revolutionaries to reject the "god of the whites" who demands crimes. How does reclamation of indigenous spirituality act as a shield against mental colonization?',
    },
    primarySourceText:
  ...
  },
  {
    ...
    summary:
      'Black Loyalists who founded Freetown petited against the oppressive and paternalistic administration of the corporate Sierra Leone Company, demanding autonomous governance.',
    mediaType: 'text',
    ...
    principle: {
      ...
      systemOfRestraint:
        'Corporate colonial administrators framed Black settlers as ungrateful dependents, ignoring their legal and democratic claims to land and freedom.',
      culturalExpression:
        'Written petitions, community delegation (Cato Perkins and Isaac Anderson), and labor strikes against company taxes.',
      inferencePrompt:
        'The Freetown settlers fought for land and self-determination against a charter company. In what ways do corporate entities limit community self-determination in your city today?',
    },
    primarySourceText:
  ...
  },
  {
    ...
    summary:
      'Nana Yaa Asantewaa, Queen Mother of Edweso, organized Asante armed resistance against the British demand for the Golden Stool, securing it from capture.',
    mediaType: 'text',
    ...
    location: { lat: 6.7, lng: -1.62, name: 'Kumasi, Gold Coast (Ghana)' },
    principle: {
      corePrinciple: 'Sovereignty Defense and Matriarchal Commander-in-Chief',
      systemOfRestraint:
        'Colonial narratives portrayed African conquest as swift and passive, ignoring the advanced military tactics and leadership of women in anti-colonial wars.',
      culturalExpression:
        'Construction of massive log stockades (Bekwai/Kokofu roads) to block artillery; mobilization chants and military oaths.',
      inferencePrompt:
        'Yaa Asantewaa declared she would lead Asante women to fight if the men refused. How does your community value and support matriarchal leadership in modern organizing?',
    },
    primarySourceText:
  ...
  },
  {
    ...
    summary:
      'The UNIA Convention produced the "Declaration of Rights of the Negro Peoples of the World," asserting complete global citizenship, economic rights, and symbolic sovereignty.',
    mediaType: 'text',
    ...
    principle: {
      ...
      systemOfRestraint:
        'Global white supremacy enforced legal segregation, lower wages, mob lynching, and lowercase writing of racial names to deny Black humanity.',
      culturalExpression:
        'Red, Black, and Green flag, the universal anthem "Ethiopia, Thou Land of Our Fathers", and massive parade displays.',
      inferencePrompt:
        'Declaration 41 states that limited liberty is but a modified form of slavery. Where do you see "limited liberty" or partial citizenship still operating in your society?',
    },
    primarySourceText:
  ...
  },
  {
    ...
    summary:
      'The Congress of the People adopted the Freedom Charter in Kliptown, South Africa. It declared a democratic, non-racial South Africa with shared national wealth and land redistribution.',
    mediaType: 'text',
    ...
    principle: {
      ...
      systemOfRestraint:
        'The apartheid regime enforced minority rule, spatial enclosure, and race-based disenfranchisement, labeling democratic movements as communist subversion.',
      culturalExpression: 'Multiracial congress, protest songs, and national consensus petition campaigns.',
      inferencePrompt:
        'The Charter declares: "South Africa belongs to all who live in it, black and white." How does a liberation movement reconcile the demand for racial equality with the demand for land redistribution?',
    },
    primarySourceText:
  ...
  },
  {
    ...
    summary:
      'Cabral theorized that national liberation is necessarily an act of culture. It requires the reassertion of authentic cultural identity to resist imperial domination.',
    mediaType: 'text',
    ...
    principle: {
      ...
      systemOfRestraint:
        'Imperialism attempts to repress the cultural life of the colonized to force assimilation and maintain economic extraction through local proxies.',
      culturalExpression: 'Folk traditions, native languages, and revolutionary theater integrated with political education.',
      inferencePrompt:
        'Cabral argued that the colonizer often seeks to replace themselves with a "native oppressor." How can modern movements ensure that structural decolonization goes deeper than representation?',
    },
    primarySourceText:
  ...
  },
  {
    ...
    summary:
      'Burkinabé President Thomas Sankara deconstructed the sovereign debt crisis as a neocolonial tool of recolonization, proposing a collective refusal to pay and local self-reliance.',
    mediaType: 'text',
    ...
    principle: {
      ...
      systemOfRestraint:
        'Neocolonial financial structures and institutions (IMF/World Bank) use debt interest and structural adjustments to control sovereign African budgets.',
      culturalExpression:
        'Peasant-grown cotton clothing (Faso Dan Fani) worn by Burkinabé delegates; agro-ecological campaigns and mass vaccinations.',
      inferencePrompt:
        'Sankara argued that the debt cannot be paid because "if we pay, we will die; if we don\'t pay, they won\'t die." How does financial debt operate as a tool of modern colonization?',
    },
    primarySourceText:
  ...
  },
  {
    ...
    summary:
      'The UCT student movement launched #RhodesMustFall, targeting the Eurocentric curriculum, systemic racism, and demanding institutional decolonization.',
    mediaType: 'text',
    ...
    principle: {
      ...
      systemOfRestraint:
        'Neoliberal universities maintain Eurocentric curricula and symbols of white supremacy, isolating and marginalizing Black students and histories.',
      culturalExpression: 'Statue toppling, administrative occupation, and student-led seminars invoking Fanon and Biko.',
      inferencePrompt:
        'The movement stated that removing the statue was only the first step. What symbols of colonial or oppressive histories still stand in your school or city, and what needs to change?',
    },
    primarySourceText:
...
export const TIMELINE_EVENTS: TimelineEvent[] = [...ANCHOR_EVENTS, ...DIASPORA_EVENTS];
...
const ANCHOR_DOCUMENTS: LibraryDocument[] = [
  {
    ...
    commentary:
      "The Victory Stela of Piye, found at Jebel Barkal, records Piye's conquest of Egypt and his establishment of the 25th Dynasty. It reveals a sophisticated rhetoric of indigenous legitimacy, presenting the Kushite king as a defender of traditional Egyptian values rather than a foreign conqueror.",
  ...
  },
  {
    ...
    commentary:
      'Promulgated in 1236 CE by Sundiata Keita, the Manden Charter is one of the oldest constitutions in the world. It establishes fundamental rights, social structures, and ecological regulations, predating the European Enlightenment by centuries.',
  ...
  },
  {
    ...
    commentary:
      'Delivered by Dutty Boukman on August 14, 1791, this prayer served as a theological declaration of independence, urging enslaved Africans to reject the god of the enslavers and listen to the voice of liberty.',
  ...
  },
  {
    ...
    commentary:
      'Written by Nova Scotian Black Loyalist settlers in 1793, these petitions protested the paternalistic and oppressive corporate rule of the Sierra Leone Company, demanding land rights and self-governance.',
  ...
  },
  {
    ...
    commentary:
      "Delivered in 1900 in response to British demands for the Golden Stool, Nana Yaa Asantewaa's speech shamed hesitant chiefs and rallied the Asante to armed resistance, highlighting the political authority of women in Asante statecraft.",
  ...
  },
  {
    ...
    commentary:
      'Adopted at the 1920 UNIA convention in Harlem, this document served as a global charter for Black self-determination, listing grievances against segregation, demanding civil rights, and adopting Pan-African symbols.',
  ...
  },
  {
    ...
    commentary:
      'Drafted through democratic consensus in 1955, the Freedom Charter proposed a non-racial South Africa with shared national wealth and land redistribution, guiding the anti-apartheid movement.',
  ...
  },
  {
    ...
    commentary:
      "Delivered in 1970 at Syracuse University, this lecture outlines Cabral's core thesis that national liberation is necessarily an act of culture, requiring the rejection of colonial assimilation and the reclaiming of indigenous identity.",
  ...
  },
  {
    ...
    commentary:
      'Delivered at the 1987 OAU summit, this speech deconstructs the African debt crisis as a neocolonial tool of recolonization, advocating for a collective refusal to pay and local self-reliance.',
  ...
  },
  {
    ...
    commentary:
      'Released in March 2015 by University of Cape Town students, this statement outlines the call for radical decolonization of higher education, representation, and curriculum, sparking a global student movement.',
...
export const LIBRARY_DOCUMENTS: LibraryDocument[] = [...ANCHOR_DOCUMENTS, ...DIASPORA_DOCUMENTS];
...
export const LOCAL_ECHOES: LocalEcho[] = [
  {
    ...
    microHistory:
      'Following police raids on the Mangrove restaurant—a West Indian community sanctuary—activists protested. The subsequent trial of the Mangrove Nine successfully forced the UK courts to recognize systemic racial bias in police conduct.',
    physicalSpace:
      'Then: A Caribbean restaurant serving as a community sanctuary. Now: A high-end commercial Notting Hill residential zone.',
    principle: {
      corePrinciple: 'Legal Defiance and Community Gathering',
      systemOfRestraint:
        'UK authorities used drug laws and street harassment to criminalize Black social spaces, attempting to close down gathering spaces for West Indian immigrants.',
      ...
      inferencePrompt:
        'The Mangrove restaurant was targeted because it was a sanctuary for immigrants. What cultural community hubs in your city are currently facing pressure or policing today?',
    },
  },
  {
    ...
    microHistory:
      'Irish volunteers seized control of the Dublin General Post Office, declaring an independent Irish Republic. Their armed rebellion was crushed by British artillery, but it ignited the final war for Irish independence.',
    physicalSpace:
      "Then: The civic heart of imperial communication. Now: Dublin's functioning central Post Office and a national monument.",
    principle: {
      corePrinciple: 'Seizing the Channels of Empire',
      systemOfRestraint:
        'British military occupation and land acts stripped Irish citizens of economic and political sovereignty, using martial law to suppress republican organizations.',
      culturalExpression:
        'Reading the "Proclamation of the Republic" from the GPO steps transformed a civic building into a stage of liberation.',
      inferencePrompt:
        "The rebels seized the Post Office to disrupt the empire's communication network. What local structures of power exist in your city today, and how do local movements seek to reform or occupy them?",
    },
  },
  {
    ...
    microHistory:
      'During the 1905 Revolution, factory workers established the first Soviet (Council) to coordinate general strikes and demand democratic rights, creating a prototype for collective labor sovereignty.',
    physicalSpace:
      'Then: Dense, industrial manufacturing districts and brick factories. Now: Redeveloped cultural hubs, galleries, and residential streets.',
    principle: {
      corePrinciple: 'Direct Democratic Labor Council',
      systemOfRestraint:
        'The Tsarist autocracy outlawed trade unions and assembly, relying on police violence and military crackdowns to suppress collective bargaining.',
      ...
      inferencePrompt:
        'Striking workers created their own democratic councils when the Tsar refused representation. What direct democratic assemblies or worker-run co-ops can you find in your city today?',
    },
  },
  {
    ...
    microHistory:
      'Senegal hosted the first global celebration of Black culture and Negritude, bringing together Duke Ellington, Langston Hughes, Aimé Césaire, and thousands of artists to celebrate post-colonial cultural sovereignty.',
    physicalSpace:
      'Then: A newly built national theatre and open-air arenas. Now: Capital city cultural institutions and national monuments.',
    principle: {
      corePrinciple: 'Pan-African Cultural Sovereignty',
      systemOfRestraint:
        'Colonial powers systematically stripped occupied peoples of their heritage, claiming African culture lacked historical value and sophistication.',
      culturalExpression:
        'Worldwide exhibitions of modern Black art, traditional dances, and decolonial poetry readings in the African sun.',
      inferencePrompt:
        "Dakar hosted a global festival to affirm that cultural sovereignty precedes political freedom. What local festivals or art showcases celebrate your neighborhood's cultural inheritance?",
    },
  },
  {
    id: 'echo-soweto-uprising',
    location: { lat: -26.2485, lng: 27.854, name: 'Soweto, Johannesburg, South Africa', region: 'Africa' },
    year: 1976,
    title: 'The Soweto Student Uprising',
    microHistory:
      'Over 10,000 Black students marched peacefully to protest the forced imposition of Afrikaans in their schools. The police opened fire, killing Hector Pieterson and igniting a global campaign against apartheid.',
    ...
    principle: {
      ...
      systemOfRestraint:
        'The apartheid regime used Bantu Education to keep Black children in perpetual manual labor, restricting native language and pride.',
      culturalExpression: 'Students sang freedom songs and carried handwritten placards while marching in school uniforms.',
      inferencePrompt:
        'Students in Soweto put their bodies on the line to protest inferior school conditions. What inequalities exist in your local school system today, and how are youth organizing?',
    },
  },
  {
    ...
    microHistory:
      'Over 3,000 students gathered in Tiananmen Square to protest the Treaty of Versailles, which handed Chinese territory to Japan. This local student protest catalyzed a national wave of intellectual modernization.',
    ...
    principle: {
      ...
      systemOfRestraint:
        'Western powers and corrupt local warlords carved up Chinese territory and assets, treating the country as colonial territory.',
      ...
      inferencePrompt:
        'Students in Beijing protested local land loss to foreign empires. What local environmental or land-use issues in your city are currently being protested by youth?',
    },
  },
  {
    id: 'echo-mumbai-dalit-panthers',
    location: { lat: 19.076, lng: 72.8777, name: 'Mumbai, India', region: 'Asia' },
    year: 1972,
    title: 'Founding of the Dalit Panthers',
    microHistory:
      'Inspired by the US Black Panthers, writers Namdeo Dhasal and J.V. Pawar founded the Dalit Panthers in Siddharth Vihar. They used radical literature and self-defense to combat caste-based violence and untouchability.',
    physicalSpace:
      'Then: A crowded tenement residential building for marginalized students. Now: A busy educational campus and local residential blocks.',
    principle: {
      corePrinciple: 'Radical Literary and Self-Defense Coalition',
      systemOfRestraint:
        'The ancient caste system segregated Dalits (Untouchables), exposing them to regular systemic violence and denying them access to public water and schools.',
      ...
      inferencePrompt:
        'The Dalit Panthers adapted the tactics of the Black Panthers to fight caste discrimination in India. What international civil rights symbols or strategies have local groups in your city adopted?',
    },
  },
  {
    ...
    microHistory:
      'Black auto workers at the Hamtramck Assembly plant founded DRUM to protest double exploitation by Chrysler management and the white-led UAW union. They held wildcat strikes and shut down assembly lines.',
    ...
    principle: {
      ...
      systemOfRestraint:
        'Automotive plants relied on Black workers for the most dangerous, lowest-paid jobs, while union hierarchies colluded with management to suppress grievances.',
      culturalExpression: 'Hand-typed newspapers and plant-gate rallies built worker consciousness at the point of production.',
      inferencePrompt:
        'Detroit auto workers organized wildcat strikes because their own union ignored them. When mainstream organizations fail, what alternative or independent groups do workers in your city form?',
    },
  },
];
...
export function getEventsForRegion(region: Region): TimelineEvent[] {
  return TIMELINE_EVENTS.filter((e) => e.region === region).sort((a, b) => a.year - b.year);
}
...
export function getEventsInRange(startYear: number, endYear: number): TimelineEvent[] {
  return TIMELINE_EVENTS.filter((e) => e.year >= startYear && e.year <= endYear).sort((a, b) => a.year - b.year);
}

/** Return events for a region within a year range */
export function getFilteredEvents(region: Region | 'All', startYear: number, endYear: number): TimelineEvent[] {
  return TIMELINE_EVENTS.filter((e) => (region === 'All' || e.region === region) && e.year >= startYear && e.year <= endYear).sort(
    (a, b) => a.year - b.year,
  );
}
