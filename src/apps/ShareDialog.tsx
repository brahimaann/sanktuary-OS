  ...
  return (
    <div style={{ position: 'absolute', inset: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 5 }}>
      ...
      >
        ...
        <label>
          To{' '}
          <select value={to} onChange={(e) => setTo(e.target.value)} style={{ fontFamily: 'inherit', fontSize: 11 }}>
            {targets.map((t) => (
        ...
        <input
          ...
          style={{ fontFamily: 'inherit', fontSize: 11, border: '2px inset #808080', padding: 2 }}
        />
